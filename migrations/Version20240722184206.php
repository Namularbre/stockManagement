 ...
 */
final class Version20240722184206 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__product AS SELECT id, storage_id, name, description, quantity, created_at, min_quantity FROM product');
        ...
        $this->addSql('INSERT INTO product (id, storage_id, name, description, quantity, created_at, min_quantity) SELECT id, storage_id, name, description, quantity, created_at, min_quantity FROM __temp__product');
